  ...
  return (
    <Dialog open={isOpen} onClose={onClose} className="relative z-50">
      ...
      <div className="fixed inset-0 flex items-center justify-center p-4">
        <Dialog.Panel className="mx-auto max-w-4xl w-full bg-zinc-950 border border-white/10 rounded-xl p-6 max-h-[90vh] overflow-y-auto">
          <div className="flex justify-between items-center mb-6">
            <Dialog.Title className="text-xl font-bold text-white">
              Customs, Taxes & Duties Information
            </Dialog.Title>
          ...
          <div className="space-y-6">
            ...
            {/* VAT Rates Table */}
            <div>
              <h3 className="text-lg font-semibold text-white mb-4">European Union VAT Rates</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {VAT_RATES.map(({ country, rate }) => (
                  <div
                    key={country}
                    className="bg-zinc-900/50 border border-white/10 rounded-lg p-4 flex justify-between items-center"
                  >
